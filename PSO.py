...
class PSO(SkoBase):
    ...
    def __init__(self, func, n_dim=None, pop=40, max_iter=150, lb=-1e5, ub=1e5, w=0.8, c1=1, c2=1,
                 constraint_eq=tuple(), constraint_ueq=tuple(), verbose=False
                 , dim=None, auto_coef=False):
        ...
        self.auto_coef = auto_coef # optimize the coefficients during iterations
